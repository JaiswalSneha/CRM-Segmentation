...
model_lr = LogisticRegression(solver='saga', max_iter=1000, tol=1e-4)
...
model_km2_0 = LogisticRegression(solver='saga', max_iter=1000, tol=1e-4)
...
model_km2_1 = LogisticRegression(solver='saga', max_iter=1000, tol=1e-4)
